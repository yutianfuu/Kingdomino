...
public class BrowseDomino{
	
	//public BrowseDomino() {}
	
	public static List<Domino> BrowseAllDominoes() {
	...
	public static Domino BrowseDominoById(int id) {
		Kingdomino tempking = KingdominoApplication.getKingdomino();
		Game anygame = new Game(48,tempking);
		createAllDominoes(anygame);
	...
	public static List<Domino> FilterDominoByTerrain(TerrainType terrain){
		Kingdomino tempking = KingdominoApplication.getKingdomino();
		Game anygame = new Game(48,tempking);
		createAllDominoes(anygame);
	...
	private static void ShowDominos(List<Domino> selection) {
		int counter = 0;
	...
	private static void ShowFilterDominos(List<Domino> selection, TerrainType terrain) {
		int counter =0;
